...
<html>
    ...
    <body id="bo">
        <div id="div-menu" class="ui fluid six item menu">
            <a href="${createLink(uri: '/')}" class=" header item"><asset:image class="ui mini circular image" src="logo_biblioteca.png" alt="Inicio"/>Inicio</a>
        ...
        <div id="div-content" class="ui segment conten">
            <div id="form-busqueda-div" class="ui segment container">
                <g:form id="busqueda" class="ui form" action="show">
                    ...
                    <g:submitButton name="buscar" class="ui button blue" value="${message(code: 'pincipal.busqueda', default: 'Buscar')}"></g:submitButton>
                </g:form>
            </div>

...
<body>   
    <div class="nav" role="navigation">
        ...
        <div id="list-libro" class="content scaffold-list" role="main">
            <h1><g:message code="default.principal.titLib" /></h1>
        </br>
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <g:sortableColumn property="autor" title="Autor"><g:message code="libro.autor.label" default="Autor" /></g:sortableColumn>

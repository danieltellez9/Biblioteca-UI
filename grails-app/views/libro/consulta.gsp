...
<html>
    <head>
        ...
        <title><g:message code="default.libro.consultar"/></title>
    </head>
    <body>
        <div class="ui menu">
            ...
            <a href="${createLink(uri: '/libro/create')}" class="item"><asset:image class="ui mini image" src="add_icon.png" alt="Nuevo Libro"/><g:message code="default.biblioteca.inicio"/></a>
        ...
        <div id="div-content" class="ui segment container">
            <div id="form-busqueda-div" class="ui segment container">
                <g:form id="busqueda" class="ui form" action="consulta">
                    ...
                    <g:submitButton name="buscar" class="ui button blue" value="${message(code: 'pricipal.busqueda', default: 'Buscar')}"/>
                </g:form>
            </div>
            ...
            <div id="div-tabla" class="ui segment container">
                <div class="ui medium header">Consulta de libros</div>
